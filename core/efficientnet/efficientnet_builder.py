...
import core.efficientnet.efficientnet_model as efficientnet_model
import core.efficientnet.utils as utils
...
def build_model_base(images, model_name, training, override_params=None, getter = None):
  ...
  with tf.variable_scope(model_name, reuse = tf.AUTO_REUSE, custom_getter = getter):
    model = efficientnet_model.Model(blocks_args, global_params)
